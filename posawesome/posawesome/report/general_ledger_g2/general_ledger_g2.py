...
def get_gl_entries(filters, accounting_dimensions):
	...
	gl_entries = frappe.db.sql(
		...
		select
			...
			(SELECT narration FROM `tabJournal Entry Account` WHERE parent = voucher_no AND account = account LIMIT 1) AS narration,
			cost_center, project,
...
def get_columns(filters):
	...
	columns = [
		...
		{"label": _("Narration"), "fieldname": "narration", "width": 250},
