{% include "posawesome/posawesome/page/rmsapp/onscan.js" %}
frappe.pages['rmsapp'].on_page_load = function (wrapper) {
	...
	this.page.$RmsApp = new frappe.RmsApp.rmsapp(this.page);
