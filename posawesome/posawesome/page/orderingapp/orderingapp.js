{% include "posawesome/posawesome/page/orderingapp/onscan.js" %}
frappe.pages['orderingapp'].on_page_load = function(wrapper) {
	var page = frappe.ui.make_app_page({
		parent: wrapper,
		title: 'Ordering Module',
		single_column: true
	});
	this.page.$OrderingApp = new frappe.OrderingApp.orderingapp(this.page);
