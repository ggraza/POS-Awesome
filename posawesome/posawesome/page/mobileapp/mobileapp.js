{% include "posawesome/posawesome/page/mobileapp/onscan.js" %}
frappe.pages['mobileapp'].on_page_load = function(wrapper) {
	...
	this.page.$MobileApp = new frappe.MobileApp.mobileapp(this.page);
