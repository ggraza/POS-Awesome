{% include "posawesome/posawesome/page/price_checker/onscan.js" %}
frappe.pages['price_checker'].on_page_load = function(wrapper) {
	var page = frappe.ui.make_app_page({
		parent: wrapper,
		title: 'G2 Price Checker',
		single_column: true
	});

	this.page.$PriceChecker = new frappe.Price_Checker.price_checker(this.page);
