{% include "posawesome/posawesome/page/pricechecker/onscan.js" %}
frappe.pages['pricechecker'].on_page_load = function(wrapper) {
	...
	this.page.$PriceChecker = new frappe.PriceChecker.pricechecker(this.page);
