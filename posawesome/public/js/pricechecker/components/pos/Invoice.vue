<template>
  <div>
    ...
    <v-row align="center" class="items px-0 py-1 mt-0 pt-0" v-show="!dialog">
      ...
      <div class="my-1 py-1 overflow-y-auto" style="min-height: 85vh">
      ...
      <v-col md="4" cols="12" class="pb-3">
        <v-card class="invoices mx-auto grey lighten-5 mt-3 p-3" style="max-height: 92vh; height: 92vh">
      <v-row no-gutters>
...
export default {
  ...
  beforeDestroy() {
    if (this.clearIinvoice) {
      clearInvoice(this.clearInvoice);
    }
