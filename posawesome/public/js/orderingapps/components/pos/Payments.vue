      ...
      <v-row align="start" no-gutters>
        <v-col cols="6">
          <v-btn
            ...
            ><v-icon left>mdi-credit-card</v-icon>{{ __("Submit") }}</v-btn
          >
        </v-col>
        <v-col cols="6" class="pl-1">
          <v-btn
            ...
            :disabled="vaildatPayment"
            ><v-icon left>mdi-printer</v-icon>{{ __("Submit & Print") }}</v-btn
          >
        </v-col>
        <v-col cols="12">
          <v-btn
            ...
            ><v-icon>mdi-close-circle</v-icon>{{ __("Cancel Payment") }}</v-btn
          >
        </v-col>
      </v-row>
    </v-card>
